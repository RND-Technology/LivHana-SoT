...
│   │   ├── 📄 [PURGED_FALLACY]_integration_crisis_baseline.md
...
│   ├── 📁 level_next_target/
│   │   ├── 📄 [PURGED_FALLACY]_integration_resolved_next.md
...
│   │   ├── 📄 business_operations_[PURGED_FALLACY]_crisis_sessions.md
...
│   │   ├── 📄 crisis_response_[PURGED_FALLACY]_integration.md
...
│   ├── 📁 phase_3_integration/
│   │   ├── 📄 [PURGED_FALLACY]_integration_resolution.md
...
│   │   ├── 📄 customer_onboarding_[PURGED_FALLACY]_resolution.md
...
- `20250914_coi_operations_[PURGED_FALLACY]_integration_priority.md`
