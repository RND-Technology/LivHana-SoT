/**
 * Rate Limiting Middleware with Redis Store (ESM version)
...
export const stats = new RateLimitStats();

/**
 * Create Redis client for rate limiting
 */
export const createRedisClient = async ({ logger }) => {
 ...
 */
export const createRateLimiter = ({ redisClient, config, logger, name = 'api' }) => {
 ...
 */
export const createTieredRateLimiter = ({ redisClient, logger, serviceName = 'api' }) => {
 ...
 */
export const createHealthCheckLimiter = ({ redisClient, logger, serviceName = 'api' }) => {
 ...
 */
export const createMonitoringRoutes = ({ logger }) => {
