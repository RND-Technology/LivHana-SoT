...
const mockLightspeed = {
    ...
    post: jest.fn().mockResolvedValue({ data: { Sale: { saleID: 'test-123', calcTotal: '10.00' } } }),
};
...
axios.create = jest.fn().mockReturnValue(mockLightspeed);
Anthropic.mockImplementation(() => mockClaude);
...
//# sourceMappingURL=voice-commerce.test.js.map