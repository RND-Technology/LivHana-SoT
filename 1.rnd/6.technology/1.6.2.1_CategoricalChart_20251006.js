...
const React = _react;
const _RootSurface = require("../container/RootSurface");
...
const _excluded = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
...
const CategoricalChart = exports.CategoricalChart = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  let {
      children,
      className,
      width,
