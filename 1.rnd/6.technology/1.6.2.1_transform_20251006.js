...
const import_tsconfig_loader = require("../third_party/tsconfig-loader");
const import_util = require("../util");
const import_utilsBundle = require("../utilsBundle");
const import_compilationCache = require("./compilationCache");
const import_pirates = require("../third_party/pirates");
