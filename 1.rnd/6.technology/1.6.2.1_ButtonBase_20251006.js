...
const _useIsFocusVisible = _interopRequireDefault(require("../utils/useIsFocusVisible"));
const _TouchRipple = _interopRequireDefault(require("./TouchRipple"));
const _buttonBaseClasses = _interopRequireWildcard(require("./buttonBaseClasses"));
...
const _default = exports.default = ButtonBase;