...
const _Collapse = _interopRequireDefault(require("../Collapse"));
const _Paper = _interopRequireDefault(require("../Paper"));
const _AccordionContext = _interopRequireDefault(require("./AccordionContext"));
...
const _accordionClasses = _interopRequireWildcard(require("./accordionClasses"));
...
const _default = exports.default = Accordion;