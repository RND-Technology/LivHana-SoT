...
const _Avatar = _interopRequireWildcard(require("../Avatar"));
const _avatarGroupClasses = _interopRequireWildcard(require("./avatarGroupClasses"));
...
const _default = exports.default = AvatarGroup;