...
const mouseClickAction = exports.mouseClickAction = (0, _toolkit.createAction)('mouseClick');
const mouseClickMiddleware = exports.mouseClickMiddleware = (0, _toolkit.createListenerMiddleware)();
...
mouseClickMiddleware.startListening({
  ...
  effect: (action, listenerApi) => {
    ...
    const activeProps = (0, _selectActivePropsFromChartPointer.selectActivePropsFromChartPointer)(listenerApi.getState(), (0, _getChartPointer.getChartPointer)(mousePointer));
...
const mouseMoveAction = exports.mouseMoveAction = (0, _toolkit.createAction)('mouseMove');
const mouseMoveMiddleware = exports.mouseMoveMiddleware = (0, _toolkit.createListenerMiddleware)();
mouseMoveMiddleware.startListening({
  ...
  effect: (action, listenerApi) => {
    ...
    const activeProps = (0, _selectActivePropsFromChartPointer.selectActivePropsFromChartPointer)(state, (0, _getChartPointer.getChartPointer)(mousePointer));
