...
<!-- RPM: 1.6.2.1.1.6.2.1_payment_20251006 -->
...
| `employeeId` | `string \| undefined` | Optional | **Deprecated**: Use `Payment.team_member_id` instead.<br><br>An optional ID of the employee associated with taking the payment.<br>**Constraints**: *Maximum Length*: `192` |
