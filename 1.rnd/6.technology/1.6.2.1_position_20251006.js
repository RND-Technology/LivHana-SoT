...
const _offsetParent = _interopRequireDefault(require("./offsetParent"));
...
function position(node, offsetParent) {
  ...
  let offset; // Fixed elements are offset from window (parentOffset = {top:0, left: 0},
  ...
  const marginLeft = String((0, _css.default)(node, 'marginLeft') || 0); // Subtract parent offsets and node margins
