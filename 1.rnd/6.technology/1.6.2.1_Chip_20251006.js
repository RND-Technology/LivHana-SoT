...
const _Cancel = _interopRequireDefault(require("../internal/svg-icons/Cancel"));
const _useForkRef = _interopRequireDefault(require("../utils/useForkRef"));
const _unsupportedProp = _interopRequireDefault(require("../utils/unsupportedProp"));
...
const _chipClasses = _interopRequireWildcard(require("./chipClasses"));
...
const _default = exports.default = Chip;