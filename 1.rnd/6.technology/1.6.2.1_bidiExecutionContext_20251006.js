...
const bidiExecutionContext_exports = {};
...
const import_utilityScriptSerializers = require("../../utils/isomorphic/utilityScriptSerializers");
const js = __toESM(require("../javascript"));
const dom = __toESM(require("../dom"));
const import_bidiDeserializer = require("./third_party/bidiDeserializer");
const bidi = __toESM(require("./third_party/bidiProtocol"));
const import_bidiSerializer = require("./third_party/bidiSerializer");
