...
(function(){
  let ref$, any, all, isItNaN, types, defaultType, toString$ = {}.toString;
  ...
  function checkFields(input, type, options){
    let inputKeys, numInputKeys, k, numOfKeys, key, ref$, types;
    inputKeys = {};
    numInputKeys = 0;
    for (k in input) {
      inputKeys[k] = true;
  ...
  function check(input, typeObj, options){
    let type, structure, setting, that;
