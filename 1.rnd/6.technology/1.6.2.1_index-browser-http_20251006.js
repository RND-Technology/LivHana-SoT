...
const convert_legacy_browser_http_options_1 = require("./configuration/convert-legacy-browser-http-options");
...
const create_legacy_browser_delegate_1 = require("./configuration/create-legacy-browser-delegate");
