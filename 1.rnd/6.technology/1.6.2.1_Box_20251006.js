...
const _className = require("../className");
const _styles = require("../styles");
const _identifier = _interopRequireDefault(require("../styles/identifier"));
const _boxClasses = _interopRequireDefault(require("./boxClasses"));
...
const _default = exports.default = Box;