...
<!-- RPM: 1.6.2.1.1.6.2.1_o-auth_20251006 -->
...
Replace `APPLICATION_SECRET` with the application secret on the __OAuth__
page for your application in the Developer Dashboard.

:information_source: __Note__ This endpoint does not require authentication.
