...
const defaultAccessor = entry => Array.isArray(entry.value) ? (0, _last.default)(entry.value) : entry.value;
const CartesianLabelListContext = /*#__PURE__*/(0, _react.createContext)(undefined);
const CartesianLabelListContextProvider = exports.CartesianLabelListContextProvider = CartesianLabelListContext.Provider;
const PolarLabelListContext = /*#__PURE__*/(0, _react.createContext)(undefined);
const PolarLabelListContextProvider = exports.PolarLabelListContextProvider = PolarLabelListContext.Provider;
...
function LabelList(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Layer.Layer, {
    ...
    let _restProps$fill;
    const value = (0, _DataUtils.isNullish)(dataKey) ? valueAccessor(entry, index) : (0, _ChartUtils.getValueByDataKey)(entry && entry.payload, dataKey);
    const idProps = (0, _DataUtils.isNullish)(id) ? {} : {
