...
const _Zoom = _interopRequireDefault(require("../Zoom"));
const _Fab = _interopRequireDefault(require("../Fab"));
...
const _speedDialClasses = _interopRequireWildcard(require("./speedDialClasses"));
...
const _default = exports.default = SpeedDial;