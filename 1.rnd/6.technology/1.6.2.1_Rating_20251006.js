...
const _clamp = _interopRequireDefault(require("@mui/utils/clamp"));
const _visuallyHidden = _interopRequireDefault(require("@mui/utils/visuallyHidden"));
...
const _Star = _interopRequireDefault(require("../internal/svg-icons/Star"));
const _StarBorder = _interopRequireDefault(require("../internal/svg-icons/StarBorder"));
const _DefaultPropsProvider = require("../DefaultPropsProvider");
const _styled = _interopRequireWildcard(require("../styles/styled"));
const _ratingClasses = _interopRequireWildcard(require("./ratingClasses"));
...
const _default = exports.default = Rating;