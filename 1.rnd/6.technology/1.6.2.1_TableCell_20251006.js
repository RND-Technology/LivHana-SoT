...
const _TableContext = _interopRequireDefault(require("../Table/TableContext"));
const _Tablelvl2Context = _interopRequireDefault(require("../Table/Tablelvl2Context"));
const _DefaultPropsProvider = require("../DefaultPropsProvider");
const _styled = _interopRequireDefault(require("../styles/styled"));
const _tableCellClasses = _interopRequireWildcard(require("./tableCellClasses"));
...
const _default = exports.default = TableCell;