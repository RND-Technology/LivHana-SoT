...
const _linkClasses = _interopRequireWildcard(require("./linkClasses"));
const _getTextDecoration = _interopRequireWildcard(require("./getTextDecoration"));
...
const _default = exports.default = Link;