...
const React = _react;
const _errorBarSlice = require("../state/errorBarSlice");
const _hooks = require("../state/hooks");
const _RegisterGraphicalItemId = require("./RegisterGraphicalItemId");
...
const ErrorBarContext = /*#__PURE__*/(0, _react.createContext)(initialContextState);
...
const useErrorBarContext = () => (0, _react.useContext)(ErrorBarContext);
exports.useErrorBarContext = useErrorBarContext;
function ReportErrorBarSettings(props) {
  const dispatch = (0, _hooks.useAppDispatch)();
  const graphicalItemId = (0, _RegisterGraphicalItemId.useGraphicalItemId)();
