...
const _generateConfigFile = _interopRequireDefault(
  require('./generateConfigFile')
);
const _modifyPackageJson = _interopRequireDefault(require('./modifyPackageJson'));
const _questions = _interopRequireWildcard(require('./questions'));
