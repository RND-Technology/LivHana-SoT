...
Utf32AutoDecoder.prototype.write = function (buf) {
  if (!this.decoder) {
    ...
    let resStr = ""
    for (let i = 0; i < this.initialBufs.length; i++) { resStr += this.decoder.write(this.initialBufs[i]) }
...
function detectEncoding (bufs, defaultEncoding) {
  ...
  let invalidLE = 0; let invalidBE = 0   // Number of invalid chars when decoded as LE or BE.
  let bmpCharsLE = 0; let bmpCharsBE = 0 // Number of BMP chars when decoded as LE or BE.
